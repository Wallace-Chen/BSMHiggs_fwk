...
bool DataEvtSummaryHandler::initTree(TTree *t)
{
    ...
    */
    ...
    t_->Branch("en_enScaleUp",          evSummary_.en_enScaleUp,            "en_enScaleUp[en]/F");
    t_->Branch("en_enScaleDown",        evSummary_.en_enScaleDown,          "en_enScaleDown[en]/F");
    t_->Branch("en_enSigmaUp",          evSummary_.en_enSigmaUp,            "en_enSigmaUp[en]/F");
    t_->Branch("en_enSigmaDown",        evSummary_.en_enSigmaDown,          "en_enSigmaDown[en]/F");
#endif    
    /* tmp
    //tau
...
bool DataEvtSummaryHandler::attachToTree(TTree *t)
{
    ...
    */
    ...
    t_->SetBranchAddress("en_enScaleUp",          evSummary_.en_enScaleUp);
    t_->SetBranchAddress("en_enScaleDown",        evSummary_.en_enScaleDown);
    t_->SetBranchAddress("en_enSigmaUp",          evSummary_.en_enSigmaUp);
    t_->SetBranchAddress("en_enSigmaDown",        evSummary_.en_enSigmaDown);
#endif
    /* tmp
    //tau
